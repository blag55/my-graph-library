...
(function (global, factory) {
  ...
  class GraphSVG {
    constructor(containerId, options = {}) {
      ...
      this.svg.style.border = `${this.options.borderWidth}px ${this.options.borderStyle} ${this.options.borderColor}`;
    ...
    updateBorder(options = {}) {
      ...
      this.options.borderWidth = options.borderWidth || this.options.borderWidth;
      this.options.borderStyle = options.borderStyle || this.options.borderStyle;
